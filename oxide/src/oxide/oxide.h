...
namespace oxide {
	...
	public:
		...
		public:
			...
			bool loadTextureAtlas(const std::string& name, const std::string& path,const std::vector<std::string>& sub_textures_names, uint32_t sub_texture_width, uint32_t sub_texture_height);
